  ...
  <div className="mb-2 relative">
    <label htmlFor="address" className="text-gray-400 absolute top-1 left-[9px] text-[12px]">Street</label>
    <input
      id="street"
  ...
  <div className="mb-2 relative">
    <label htmlFor="phone" className="text-gray-400 absolute top-1 left-[9px] text-[12px]">Phone number</label>
    <input
      id="phone"
      type="phone"
